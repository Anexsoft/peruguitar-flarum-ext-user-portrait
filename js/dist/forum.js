...
flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('peruguitar/user-portrait', function () {
  console.log('[peruguitar/user-portrait] Hello, forum and admin!');
});

/***/ }),

/***/ "./src/forum/components/UserPortrait.jsx":
/*!***********************************************!*\
  !*** ./src/forum/components/UserPortrait.jsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function addUserPortrait() {
  ...
  return m("div", {
    ...
    src: user.avatarUrl
  }), !user.avatarUrl && m("span", null, user.displayName[0])), m("div", {
    className: "pg-user-portrait-username"
  }, m("span", null, app.translator.trans('peruguitar-user-portrait.forum.welcome_back_label'), ","), m("span", null, user.displayName)));
}
...
/* harmony import */ var _components_UserPortrait__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/UserPortrait */ "./src/forum/components/UserPortrait.jsx");




flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('peruguitar/user-portrait', function () {
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'sidebarItems', function (items) {
    if (!(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().session.user)) {
      return;
    }
    items.add('UserPortrait', (0,_components_UserPortrait__WEBPACK_IMPORTED_MODULE_3__["default"])(), 1);
  });
});
